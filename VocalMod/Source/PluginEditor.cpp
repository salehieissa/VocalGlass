...
void VocalModEditor::timerCallback()
{
    ...
    const KnobRegion regions[] = {
        { &rateKnob,  rateCx, rateCy, bigMaxR, plateFracRect (rateValX0, bigValY0, rateValX1, bigValY1) },
        { &depthKnob, depCx,  depCy,  bigMaxR, plateFracRect (depValX0,  bigValY0, depValX1,  bigValY1) },
        { &feedbackKnob, fbCx,  fbCy,  smallMaxR, plateFracRect (fbCx - valHalfW,  smallValY0, fbCx + valHalfW,  smallValY1) },
        ...
        { &toneKnob,     tonCx, tonCy, smallMaxR, plateFracRect (tonCx - valHalfW, smallValY0, tonCx + valHalfW, smallValY1) },
    };
    ...
    {
        shownSync = syncOn;
        repaint (plateFracRect (syncX0, syncY0, syncX1, syncY1).expanded (12));
        repaint (plateFracRect (divTxtX0, divY0, divTxtX1, divY1).expanded (2));
    }
    if (divBox.getText() != shownDiv)
    {
        shownDiv = divBox.getText();
        repaint (plateFracRect (divTxtX0, divY0, divTxtX1, divY1).expanded (2));
    }
