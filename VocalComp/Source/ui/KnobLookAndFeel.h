...
//==============================================================================
// Premium light look for VocalComp: soft white neumorphic dome knobs with a
...
public:
    KnobLookAndFeel()
    {
        ...
        setColour (juce::ComboBox::outlineColourId, theme::cardLine);
    ...
    //==========================================================================
    // Fonts — force SF Pro Display in every standard widget.
    ...
    {
        return theme::font (juce::jmin (15.0f, (float) box.getHeight() * 0.45f), false);
    }
    ...
    //==========================================================================
    // Flat combo box: white rounded card with a hairline border + soft chevron.
                       ...
                       int, int, int, int, juce::ComboBox& box) override
    {
        ...
        juce::Path chev;
        const float cx = (float) width - 18.0f;
    ...
    //==========================================================================
    // Soft white neumorphic dome knob with a glowing accent value ring. No
    // indicator dots — the lit ring shows position. Hover grows the glow.
    ...
    // value ring. No indicator dots. All shadows are sized to fit inside the
    // caller's bounds so nothing gets clipped.
    ...
    //==========================================================================
    // Recessed groove slider with a white dome thumb and glowing accent fill.
    ...
    //==========================================================================
    // Clean white pill -> accent gradient when active. No dot, no clipped shadow.
