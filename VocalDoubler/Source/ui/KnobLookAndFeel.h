...
//==============================================================================
// Premium light look for VocalDoubler: soft white neumorphic dome knobs with a
// glowing accent value ring (no indicator dots), recessed slider grooves with
// white dome thumbs, and clean white pills that fill with an accent gradient
// when active.
//==============================================================================
...
public:
    ...
    //==========================================================================
    // Clean white pill: subtle top-down sheen + crisp hairline, no shadow, no
    // dot. Fills with an accent gradient when active.
