...
// value ring, recessed slider grooves with white dome thumbs, and clean white
// pill toggles that fill with an accent gradient when active.
//==============================================================================
...
public:
    ...
    //==========================================================================
    // Force SF Pro Display on every text surface.
    ...
    {
        return theme::font (juce::jmin (15.0f, (float) box.getHeight() * 0.55f), false);
    }

    juce::Font getSliderPopupFont (juce::Slider&) override
    {
        return theme::font (13.0f, false);
    }
