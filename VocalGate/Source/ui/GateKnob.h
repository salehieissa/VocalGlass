...
// suite ring-knob (same renderer as VocalTune/VocalGrit). No indicator dots;
// the lit ring shows position, brightening on hover / drag.
//==============================================================================
class GateKnob : public juce::Slider
{
public:
    explicit GateKnob (float arcThickness = 3.0f)
