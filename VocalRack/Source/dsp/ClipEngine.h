...
public:
    ...
    // Rack use: run the oversampler up/down WITHOUT the shaper so the plugin's
    // reported latency stays constant while the CLIP module is switched off.
    void processTransparent (juce::AudioBuffer<float>& buffer)
    {
