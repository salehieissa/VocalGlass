...
public:
    ...
    juce::Font getTextButtonFont (juce::TextButton&, int h) override { return theme::font ((float) juce::jmin (15, h - 8), true); }
    ...
    juce::Font getSliderPopupFont (juce::Slider&) override       { return theme::font (14.0f, true); }
                           ...
                           float pos, float a0, float a1, juce::Slider& s) override
    {
        ...
        drawRotaryBody (g, centre, radius, pos, a0, a1, angle,
