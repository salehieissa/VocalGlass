...
// glowing accent value ring (no indicator dots, brighter glow on hover),
// recessed slider grooves with white dome thumbs, clean white pills that fill
// with an accent gradient when active, and pink-text dropdowns.
//==============================================================================
...
public:
    ...
    juce::Font getComboBoxFont (juce::ComboBox&) override   { return theme::font (15.0f, true); }
    ...
    //==========================================================================
    // Soft white neumorphic dome with a glowing accent value ring. No indicator
    // dots — the lit ring shows position. Brighter, larger glow on hover/drag.
    ...
    //==========================================================================
    // Buttons: clean white pill with a crisp hairline, filling with an accent
    // gradient when toggled on. No shadow, no clipped halo.
